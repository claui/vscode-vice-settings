# vscode-vice-settings

This is the source code repository for the `vice-settings`
VS Code extension.
...
vscode-vice-settings depends only indirectly, e.g. through a
...
all the way down to vscode-vice-settings), the patch may be
